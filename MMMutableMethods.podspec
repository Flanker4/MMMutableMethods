#
#  Be sure to run `pod spec lint MMMutableMethods.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Flanker4" => "_flanker_@mail.ru" }
  # Or just: s.author    = ""
  # s.authors            = { "" => "" }
  ...
  s.source       = { :git => "https://github.com/Flanker4/MMMutableMethods.git", :tag => "0.0.1" }
  ...
  s.source_files  = "Classes", "MMAnonymousClass/**/*.{h,m}"
